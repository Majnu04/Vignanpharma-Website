...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm">
      ...
      <div className="hidden w-full bg-slate-50 px-4 py-2 text-xs font-medium text-slate-600 md:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2 transition-colors hover:text-primary-700">
              <Phone className="h-3 w-3" /> +91 0891-2511222
            </span>
            <a href="mailto:viptvizag@yahoo.com" className="transition-colors hover:text-primary-700">viptvizag@yahoo.com</a>
          </div>
          <div className="flex items-center gap-4">
            <Link to="/alumni" className="transition-colors hover:text-primary-700">Alumni</Link>
            <Link to="/careers" className="transition-colors hover:text-primary-700">Careers</Link>
            <Link to="/contact" className="transition-colors hover:text-primary-700">Contact</Link>
          </div>
        </div>
      </div>
